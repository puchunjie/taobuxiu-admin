        ...
        methods: {
            ...
            showTip(top){
                if(this.formValidate.ironType === '不锈钢板' && this.formValidate.surface === '2B'){
                    ...
                    this.$refs.popTip.style.top = top - 40 + 'px';
                    this.$refs.popTip.style.height = '200px';
                    ...
                    this.$refs.popTip.style.top = top + 'px';
                    this.$refs.popTip.style.height = '160px';
                }
            },
            tipHide(){
                setTimeout(() => {
